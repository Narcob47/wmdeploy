...
const ContactUs = () => {
  return (
    <section className="py-16 text-center bg-red-100 rounded-lg mx-4">
      <h2 className="text-3xl font-semibold mb-4 text-black">If you wish to support our work through a donation,  please send it to +260 978 9972 67 or email us</h2>
