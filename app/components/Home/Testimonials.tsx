...
const Testimonials = () => {
  return (
    <section className="py-16 text-center bg-gray-50">
      <h2 style={{ color: COLORS.black }} className="text-3xl font-semibold">What People Say about the WatchMission Society</h2>
      <p style={{ color: COLORS.black }} className="text-gray-500 mt-4 max-w-xl mx-auto"></p>
      <div className="mt-8">
