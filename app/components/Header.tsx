...
const Header = () => {
  ...
  return (
    <header className="flex flex-wrap justify-between items-center p-6 bg-white shadow">
      ...
      <nav className={`lg:flex lg:items-center lg:space-x-6 text-black ${isOpen ? 'absolute top-0 left-0 w-full h-full bg-white flex flex-col items-center justify-center space-y-4' : 'hidden'}`}>
